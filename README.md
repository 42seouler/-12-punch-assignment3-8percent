...
| 최유진 | [n12seconds](https://github.com/n12seconds)     | 입금,출금 API, JWT |          |
...
그래서 위의 이슈를 해결하기 위해 디비를 분산 저장함과 동시에 CQRS를 도입해 읽기와 쓰기를 나누고자 계획 했습니다<br>
상대적으로 쓰기보다는 읽기기능이 많이 쓰이고 쓰기로 인해 읽기가 방해받지 않도록 하기위해서입니다.
...
CQRS를 도입하기 위해 쓰기 디비에서 읽기 전용을 만들기 위해 sqlite 백업 명렁어를 통해 구현하고자 했는데 일정시간마다 디비 싱크를 맞추기 위한 배치모듈을 만들지 못해서 도입하지 못했습니다.
